...
def shared_plan_page(title: str, inner_html: str) -> str:
    """The /p public plan share: wrap the pre-rendered plan markdown in the plain share shell."""
    article = (f'<article><span class="eyebrow">Shared business plan · built with FILG</span>'
               f'{inner_html}{CTA}</article>')
